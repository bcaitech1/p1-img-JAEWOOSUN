...
class MaskBaseDataset(data.Dataset):
    ...
    def __init__(self, data_dir, c="multi", mean=(0.548, 0.504, 0.479), std=(0.237, 0.247, 0.246), val_ratio=0.2):
    ...
    def __getitem__(self, index):
        ...
        if self.c == "mask":
            multi_class_label = mask_label
        elif self.c == "gender":
            multi_class_label = gender_label
        elif self.c == "age":
            multi_class_label = age_label
        else:
